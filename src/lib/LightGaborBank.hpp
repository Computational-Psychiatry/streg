#ifndef LIGHTGABORBANK_HPP
#define LIGHTGABORBANK_HPP
...
class LightGaborBank : public FeatureExtractorHelper<LightGaborBank>
{
public:
    LightGaborBank(size_t _numPartsX=2,
              size_t _numPartsY=2,
...
//    LightGaborBank(const std::string& str);
